                    ...
                    <div class="input-group mb-3">
                        ...
                        <div class="btn-group dropup">
                            ...
                            <ul class="dropdown-menu">
                                <!-- Dropdown menu links -->
                                <li><button class="btn dropdown-item" id="copy" data-clipboard-target="#api_data">Copy</button></li>
        ...
        <div class="container mt-5 px-2">
            ...
            <div class="card bg-gray mb-4">
                <div class="card-header shadow-lg rounded ">
                    <h5 class="card-title ">SEARCH LOCATION USING YOUR API KEY
                        <button type="button" class="btn btn-sm btn-outline-danger float-end" data-bs-toggle="modal"
            ...
            <div class="mb-2 d-flex justify-content-between align-items-center">
                ...
                <form class="row g-3" id="postCode">
                    ...
                    <div class="col-auto">
                        <button type="submit" class="btn btn-primary mb-3 text-white" id="submitButton">Search</button>
                    </div>
                </form>
            </div>
